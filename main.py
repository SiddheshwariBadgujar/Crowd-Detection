...
# top label
start1 = tk.Label(text = "CROWD DETECTION", font=("Arial", 50,), fg="black") # same way bg
...
Button(window, text="▶ START",command=start_fun,font=("Arial", 25), bg = "sky blue", fg = "black", cursor="hand2", borderwidth=3, relief="raised").place(x =130 , y =570 )

# image on the main window
path1 = "Images/front_new.png"
img2 = ImageTk.PhotoImage(Image.open(path1))
panel1 = tk.Label(window, image = img2)
panel1.place(x = 90, y = 250)

# image on the main window
path = "Images/front_new.png"
img1 = ImageTk.PhotoImage(Image.open(path))
panel = tk.Label(window, image = img1)
panel.place(x = 650, y = 250)
...
# exit button created
Button(window, text="❌ EXIT",command=exit_win,font=("Arial", 25), bg = "violet", fg = "black", cursor="hand2", borderwidth=3, relief="raised").place(x =680 , y = 570 )
...
if exit1==False:
    ...
    def camera_option():
        ...
        def detectByCamera(writer):
            ...
            Button(windowc, text="Enumeration\nPlot", command=cam_enumeration_plot, cursor="hand2", font=("Arial", 20),bg="Sky blue", fg="blue").place(x=100, y=530)
            Button(windowc, text="Avg. Accuracy\nPlot", command=cam_accuracy_plot, cursor="hand2", font=("Arial", 20),bg="sky blue", fg="blue").place(x=700, y=530)
        ...
        info1 = tk.Label(windowc, font=("Arial", 30), fg="Black")  # same way bg
    ...
    # created exit button
    Button(window1, text="❌ EXIT",command=exit_win1,  cursor="hand2", font=("Arial", 25), bg = "violet", fg = "Black").place(x = 440, y = 600)
